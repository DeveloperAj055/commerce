...
class NCM_Cart{
    ...
    function ncm_cart_calculate_func() {
        ...
        if( isset($_POST['product']) && !empty($_POST['product']) && is_array($_POST['product'])) {
            ...
            foreach ($_POST['product'] as $product) {
                ...
                // $product_levy_id = isset($product['product_levy_id']) ? $product['product_levy_id'] : 0;
                ...
                $ncm_cart_subtotal = $ncm_cart_subtotal + $product_price;
                ...
                $ncm_cart_total = $ncm_cart_total + $product_total;
    ...
    function ncm_get_cart_pessenger_details() {
        ...
        $ncm_data = array( 'ncm_booking' => array(), 'passenger_info' => array() );
    ...
    function ncm_cart_product_func() {
        ...
        global $ncm_narnoo_helper, $ncm_controls, $ncm_settings;
