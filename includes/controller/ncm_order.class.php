...
class NCM_Order {
    ...
    function ncm_get_order_details( $order_id ) {
        ...
        if( !empty($order_id) ) {
            ...
            // $firstname = get_post_meta( $order_id, 'ncm_firstname', true );

            // $lastname = get_post_meta( $order_id, 'ncm_lastname', true );

            // $email = get_post_meta( $order_id, 'ncm_email', true );

            // $phone = get_post_meta( $order_id, 'ncm_phone', true );

            // $country = get_post_meta( $order_id, 'ncm_country', true );
            ...
            // $order_data['ncm_first_name'] = $firstname;

            // $order_data['ncm_last_name'] = $lastname;

            // $order_data['ncm_email'] = $email;

            // $order_data['ncm_phone_no'] = $phone;

            // $order_data['ncm_country'] = isset($all_country[$country]) ? $all_country[$country] : $country;
