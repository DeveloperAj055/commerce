...
class NCM_DB_settings{
	...
	function ncm_country() {
		...
		$country = array(				
			...
			"AX" => __('Aland Islands', NCM_txt_domain),

			"AF" => __('Afghanistan', NCM_txt_domain),

			"AL" => __('Albania', NCM_txt_domain),

			"DZ" => __('Algeria', NCM_txt_domain),

			"AS" => __('American Samoa', NCM_txt_domain),

			"AD" => __('Andorra', NCM_txt_domain),

			"AO" => __('Angola', NCM_txt_domain),

			"AI" => __('Anguilla', NCM_txt_domain),

			"AQ" => __('Antarctica', NCM_txt_domain),

			"AG" => __('Antigua and Barbuda', NCM_txt_domain),

			"AR" => __('Argentina', NCM_txt_domain),

			"AM" => __('Armenia', NCM_txt_domain),

			"AW" => __('Aruba', NCM_txt_domain),

			"AU" => __('Australia', NCM_txt_domain),

			"AT" => __('Austria', NCM_txt_domain),

			"AZ" => __('Azerbaijan', NCM_txt_domain),

			"BS" => __('Bahamas', NCM_txt_domain),

			"BH" => __('Bahrain', NCM_txt_domain),

			"BD" => __('Bangladesh', NCM_txt_domain),

			"BB" => __('Barbados', NCM_txt_domain),

			"BY" => __('Belarus', NCM_txt_domain),

			"PW" => __('Belau', NCM_txt_domain),

			"BE" => __('Belgium', NCM_txt_domain),

			"BZ" => __('Belize', NCM_txt_domain),

			"BJ" => __('Benin', NCM_txt_domain),

			"BM" => __('Bermuda', NCM_txt_domain),

			"BT" => __('Bhutan', NCM_txt_domain),

			"BO" => __('Bolivia', NCM_txt_domain),

			"BQ" => __('Bonaire Saint Eustatius and Saba', NCM_txt_domain),

			"BA" => __('Bosnia and Herzegovina', NCM_txt_domain),

			"BW" => __('Botswana', NCM_txt_domain),

			"BV" => __('Bouvet Island', NCM_txt_domain),

			"BR" => __('Brazil', NCM_txt_domain),

			"IO" => __('British Indian Ocean Territory', NCM_txt_domain),

			"VG" => __('British Virgin Islands', NCM_txt_domain),

			"BN" => __('Brunei', NCM_txt_domain),

			"BG" => __('Bulgaria', NCM_txt_domain),

			"BF" => __('Burkina Faso', NCM_txt_domain),

			"BI" => __('Burundi', NCM_txt_domain),

			"KH" => __('Cambodia', NCM_txt_domain),

			"CM" => __('Cameroon', NCM_txt_domain),

			"CM" => __('Canada', NCM_txt_domain),

			"CV" => __('Cape Verde', NCM_txt_domain),

			"KY" => __('Cayman Islands', NCM_txt_domain),

			"CF" => __('Central African Republic', NCM_txt_domain),

			"TD" => __('Chad', NCM_txt_domain),

			"CL" => __('Chile', NCM_txt_domain),

			"CN" => __('China', NCM_txt_domain),

			"CX" => __('Christmas Island', NCM_txt_domain),

			"CC" => __('Cocos (Keeling) Islands', NCM_txt_domain),

			"CO" => __('Colombia', NCM_txt_domain),

			"KM" => __('Comoros', NCM_txt_domain),

			"CG" => __('Congo (Brazzaville)', NCM_txt_domain),

			"CD" => __('Congo (Kinshasa)', NCM_txt_domain),

			"CK" => __('Cook Islands', NCM_txt_domain),

			"CR" => __('Costa Rica', NCM_txt_domain),

			"HR" => __('Croatia', NCM_txt_domain),

			"CU" => __('Cuba', NCM_txt_domain),

			"CW" => __('Curaçao', NCM_txt_domain),

			"CY" => __('Cyprus', NCM_txt_domain),

			"CZ" => __('Czech Republic', NCM_txt_domain),

			"DK" => __('Denmark', NCM_txt_domain),

			"DJ" => __('Djibouti', NCM_txt_domain),

			"DM" => __('Dominica', NCM_txt_domain),

			"DO" => __('Dominican Republic', NCM_txt_domain),

			"EC" => __('Ecuador', NCM_txt_domain),

			"EG" => __('Egypt', NCM_txt_domain),

			"SV" => __('El Salvador', NCM_txt_domain),

			"GQ" => __('Equatorial Guinea', NCM_txt_domain),

			"ER" => __('Eritrea', NCM_txt_domain),

			"EE" => __('Estonia', NCM_txt_domain),

			"ET" => __('Ethiopia', NCM_txt_domain),

			"FK" => __('Falkland Islands', NCM_txt_domain),

			"FO" => __('Faroe Islands', NCM_txt_domain),

			"FJ" => __('Fiji', NCM_txt_domain),

			"FI" => __('Finland', NCM_txt_domain),

			"FR" => __('France', NCM_txt_domain),

			"GF" => __('French Guiana', NCM_txt_domain),

			"PF" => __('French Polynesia', NCM_txt_domain),

			"TF" => __('French Southern Territories', NCM_txt_domain),

			"GA" => __('Gabon', NCM_txt_domain),

			"GM" => __('Gambia', NCM_txt_domain),

			"GE" => __('Georgia', NCM_txt_domain),

			"DE" => __('Germany', NCM_txt_domain),

			"GH" => __('Ghana', NCM_txt_domain),

			"GI" => __('Gibraltar', NCM_txt_domain),

 			"BR" => __('Greece', NCM_txt_domain),

			"GL" => __('Greenland', NCM_txt_domain),

			"GD" => __('Grenada', NCM_txt_domain),

			"GP" => __('Guadeloupe', NCM_txt_domain),

			"GU" => __('Guam', NCM_txt_domain),

			"GT" => __('Guatemala', NCM_txt_domain),

			"GG" => __('Guernsey', NCM_txt_domain),

			"GN" => __('Guinea', NCM_txt_domain),

			"GW" => __('Guinea-Bissau', NCM_txt_domain),

			"GY" => __('Guyana', NCM_txt_domain),

			"HT" => __('Haiti', NCM_txt_domain),

			"HM" => __('Heard Island and McDonald Islands', NCM_txt_domain),

			"HN" => __('Honduras', NCM_txt_domain),

			"HK" => __('Hong Kong', NCM_txt_domain),

			"HU" => __('Hungary', NCM_txt_domain),

			"IS" => __('Iceland', NCM_txt_domain),

			"IN" => __('India', NCM_txt_domain),

			"ID" => __('Indonesia', NCM_txt_domain),

			"IR" => __('Iran', NCM_txt_domain),

			"IQ" => __('Iraq', NCM_txt_domain),

			"IE" => __('Ireland', NCM_txt_domain),

			"IM" => __('Isle of Man', NCM_txt_domain),

			"IL" => __('Israel', NCM_txt_domain),

			"IT" => __('Italy', NCM_txt_domain),

			"CI" => __('Ivory Coast', NCM_txt_domain),

			"JM" => __('Jamaica', NCM_txt_domain),

			"JP" => __('Japan', NCM_txt_domain),

			"JE" => __('Jersey', NCM_txt_domain),

			"JO" => __('Jordan', NCM_txt_domain),

			"KZ" => __('Kazakhstan', NCM_txt_domain),

			"KE" => __('Kenya', NCM_txt_domain),

			"KI" => __('Kiribati', NCM_txt_domain),

			"KW" => __('Kuwait', NCM_txt_domain),

			"KG" => __('Kyrgyzstan', NCM_txt_domain),

			"LA" => __('Laos', NCM_txt_domain),

			"LV" => __('Latvia', NCM_txt_domain),

			"LB" => __('Lebanon', NCM_txt_domain),

			"LS" => __('Lesotho', NCM_txt_domain),

			"LR" => __('Liberia', NCM_txt_domain),

			"LY" => __('Libya', NCM_txt_domain),

			"LI" => __('Liechtenstein', NCM_txt_domain),

			"LT" => __('Lithuania', NCM_txt_domain),

			"LU" => __('Luxembourg', NCM_txt_domain),

			"MO" => __('Macao S.A.R., China', NCM_txt_domain),

			"MK" => __('Macedonia', NCM_txt_domain),

			"MG" => __('Madagascar', NCM_txt_domain),

			"MW" => __('Malawi', NCM_txt_domain),

			"MY" => __('Malaysia', NCM_txt_domain),

			"MV" => __('Maldives', NCM_txt_domain),

			"ML" => __('Mali', NCM_txt_domain),

			"MT" => __('Malta', NCM_txt_domain),

			"MH" => __('Marshall Islands', NCM_txt_domain),

			"MQ" => __('Martinique', NCM_txt_domain),

			"MR" => __('Mauritania', NCM_txt_domain),

			"MU" => __('Mauritius', NCM_txt_domain),

			"YT" => __('Mayotte', NCM_txt_domain),

			"MX" => __('Mexico', NCM_txt_domain),

			"FM" => __('Micronesia', NCM_txt_domain),

			"MD" => __('Moldova', NCM_txt_domain),

			"MC" => __('Monaco', NCM_txt_domain),

			"MN" => __('Mongolia', NCM_txt_domain),

			"ME" => __('Montenegro', NCM_txt_domain),

			"MS" => __('Montserrat', NCM_txt_domain),

			"MA" => __('Morocco', NCM_txt_domain),

			"MZ" => __('Mozambique', NCM_txt_domain),

			"MM" => __('Myanmar', NCM_txt_domain),

			"NA" => __('Namibia', NCM_txt_domain),

			"NR" => __('Nauru', NCM_txt_domain),

			"NP" => __('Nepal', NCM_txt_domain),

			"NL" => __('Netherlands', NCM_txt_domain),

			"NC" => __('New Caledonia', NCM_txt_domain),

			"NZ" => __('New Zealand', NCM_txt_domain),

			"NI" => __('Nicaragua', NCM_txt_domain),

			"NE" => __('Niger', NCM_txt_domain),

			"NG" => __('Nigeria', NCM_txt_domain),

			"NU" => __('Niue', NCM_txt_domain),

			"NF" => __('Norfolk Island', NCM_txt_domain),

			"KP" => __('North Korea', NCM_txt_domain),

			"MP" => __('Northern Mariana Islands', NCM_txt_domain),

			"NO" => __('Norway', NCM_txt_domain),

			"OM" => __('Oman', NCM_txt_domain),

			"PK" => __('Pakistan', NCM_txt_domain),

			"PS" => __('Palestinian Territory', NCM_txt_domain),

			"PA" => __('Panama', NCM_txt_domain),

			"PG" => __('Papua New Guinea', NCM_txt_domain),

			"PY" => __('Paraguay', NCM_txt_domain),

			"PE" => __('Paru', NCM_txt_domain),

			"PH" => __('Philippines', NCM_txt_domain),

			"PN" => __('Pitcairn', NCM_txt_domain),

			"PL" => __('Poland', NCM_txt_domain),

			"PT" => __('Portugal', NCM_txt_domain),

			"PR" => __('Puerto Rico', NCM_txt_domain),

			"QA" => __('Qatar', NCM_txt_domain),

			"RE" => __('Reunion', NCM_txt_domain),

			"RO" => __('Romania', NCM_txt_domain),

			"RU" => __('Russia', NCM_txt_domain),

			"RW" => __('Rwanda', NCM_txt_domain),

			"ST" => __('São Tomé and Príncipe', NCM_txt_domain),

			"BL" => __('Saint Barthélemy', NCM_txt_domain),

			"SH" => __('Saint Helena', NCM_txt_domain),

			"KN" => __('Saint Kitts and Nevis', NCM_txt_domain),

			"LC" => __('Saint Lucia', NCM_txt_domain),

			"SX" => __('Saint Martin (Dutch part)', NCM_txt_domain),

			"MF" => __('Saint Martin (French part)', NCM_txt_domain),

			"PM" => __('Saint Pierre and Miquelon', NCM_txt_domain),

			"VC" => __('Saint Vincent and the Grenadines', NCM_txt_domain),

			"WS" => __('Samoa', NCM_txt_domain),

			"SM" => __('San Marino', NCM_txt_domain),

			"SA" => __('Saudi Arabia', NCM_txt_domain),

			"SN" => __('Senegal', NCM_txt_domain),

			"RS" => __('Serbia', NCM_txt_domain),

			"SC" => __('Seychelles', NCM_txt_domain),

			"SL" => __('Sierra Leone', NCM_txt_domain),

			"SG" => __('Singapore', NCM_txt_domain),

			"SK" => __('Slovakia', NCM_txt_domain),

			"SI" => __('Slovenia', NCM_txt_domain),

			"SB" => __('Solomon Islands', NCM_txt_domain),

			"SO" => __('Somalia', NCM_txt_domain),

			"ZA" => __('South Africa', NCM_txt_domain),

			"GS" => __('South Georgia/Sandwich Islands', NCM_txt_domain),

			"KR" => __('South Korea', NCM_txt_domain),

			"SS" => __('South Sudan', NCM_txt_domain),

			"ES" => __('South Sudan', NCM_txt_domain),

			"LK" => __('Sri Lanka', NCM_txt_domain),

			"SD" => __('Sudan', NCM_txt_domain),

			"SR" => __('Suriname', NCM_txt_domain),

			"SJ" => __('Svalbard and Jan Mayen', NCM_txt_domain),

			"SZ" => __('Swaziland', NCM_txt_domain),

			"SE" => __('Sweden', NCM_txt_domain),

			"CH" => __('Switzerland', NCM_txt_domain),

			"SY" => __('Syria', NCM_txt_domain),

			"TW" => __('Taiwan', NCM_txt_domain),

			"TJ" => __('Tajikistan', NCM_txt_domain),

			"TZ" => __('Tanzania', NCM_txt_domain),

			"TH" => __('Thailand', NCM_txt_domain),

			"TL" => __('Timor-Leste', NCM_txt_domain),

			"TG" => __('Togo', NCM_txt_domain),

			"TK" => __('Tokelau', NCM_txt_domain),

			"TO" => __('Tonga', NCM_txt_domain),

			"TT" => __('Trinidad and Tobago', NCM_txt_domain),

			"TN" => __('Tunisia', NCM_txt_domain),

			"TR" => __('Turkey', NCM_txt_domain),

			"TM" => __('Turkmenistan', NCM_txt_domain),

			"TC" => __('Turks and Caicos Islands', NCM_txt_domain),

			"TV" => __('Tuvalu', NCM_txt_domain),

			"UG" => __('Uganda', NCM_txt_domain),

			"UA" => __('Ukraine', NCM_txt_domain),

			"AE" => __('United Arab Emirates', NCM_txt_domain),

			"GB" => __('United Kingdom (UK)', NCM_txt_domain),

			"US" => __('United States (US)', NCM_txt_domain),

			"UM" => __('United States (US) Minor Outlying Islands',NCM_txt_domain),

			"VI" => __('United States (US) Virgin Islands', NCM_txt_domain),

			"UY" => __('Uruguay', NCM_txt_domain),

			"UZ" => __('Uzbekistan', NCM_txt_domain),

			"VU" => __('Vanuatu', NCM_txt_domain),

			"VA" => __('Vatican', NCM_txt_domain),

			"VE" => __('Venezuela', NCM_txt_domain),

			"VN" => __('Vietnam', NCM_txt_domain),

			"WF" => __('Wallis and Futuna', NCM_txt_domain),

			"EH" => __('Western Sahara', NCM_txt_domain),

			"YE" => __('Yemen', NCM_txt_domain),

			"ZM" => __('Zambia', NCM_txt_domain),

			"ZW" => __('Zimbabwe', NCM_txt_domain),
