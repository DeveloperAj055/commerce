<div class="ncm-order">
    ...
    <ul class="ncm-order-overview ncm-thankyou-order-details order_details order_summary_custom">
        <li class="ncm-order-overview__order order">
            First Name: <strong>James</strong>
        </li>

        <li class="ncm-order-overview__date date">
            Last Name: <strong>Wells</strong>
        </li>
        
        <li class="ncm-order-overview__email email">
            Email: <strong>tester@gmail.com</strong>
        </li>
        
        <li class="ncm-order-overview__total total">
            Mobile Phone: <strong>9876543210</strong>
        </li>
