...
<div class="modal-header">
    <h4 class="modal-title ncm_option_list_title" >
        ...
        <a href="javascript:void(0);" class="pull-right" data-dismiss="modal"> X </a>
    </h4>
</div>

<div class="modal-body table-responsive " class="ncm_option_list_content">
