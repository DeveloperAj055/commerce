<div class="ncm-order">
	...
	<ul class="ncm-order-overview ncm-thankyou-order-details order_details order_summary_custom">
		...
		<li class="ncm-order-overview__total total">            
			<?php _e('Sub Total', NCM_txt_domain); ?>: <strong><?php echo $ncm_subtotal; ?></strong>        
		</li>        
		<?php /*         <li class="ncm-order-overview__total total">            <?php _e('Levy', NCM_txt_domain); ?>: <strong><?php echo $ncm_levy; ?></strong>        </li>        */ ?>               <li class="ncm-order-overview__total total">            
			<?php _e('Total', NCM_txt_domain); ?>: <strong><?php echo $ncm_total; ?></strong>        
		</li>    
	</ul>        
	...
	<div class="table-responsive">            
		<table class="ncm-table ncm-table--order-details shop_table order_details order_summary_table table-bordered">                
			...
			<tr>
				...
				<?php /* <th class="ncm-table__product-name product-name"><?php _e('Levy', NCM_txt_domain); ?></th> */ ?>
