<?php
    ...
    if( count($passenger_type) == 0 ) {
        ...
        $toottip_data.= '<th>'.__('Sell and Levy', NCM_txt_domain).'</th>';
...
<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 ncm_date ncm_price_model <?php echo $availability_class; ?> ">
    ...
    <h6 class="product-price mt5" data-toggle="tooltip" data-html="true" title="<?php echo $toottip_data; ?>">
