...
jQuery(document).on("click", "#ncm_option_list_selected_date", function() {
    ...
    if( this_elem.parents('.modal-body').find('.ncm_price_availability_loader').length > 0 ) {

        this_elem.parents('.modal-body').find('.ncm_price_availability_loader').show();
    ...
    jQuery.ajax({
        ...
        error: function(e) {
            ...
            jQuery('#ncm_option_list').modal('show');
        ...
        success: function(result){
            ...
            if( result.status == 'success' ) {
                ...
                jQuery('#ncm_option_list').modal('hide');

            }

            if( this_elem.parents('.modal-body').find('.ncm_price_availability_loader').length > 0 ) {

                this_elem.parents('.modal-body').find('.ncm_price_availability_loader').hide();
...
jQuery(document).on("click", ".product-info #chk_price", function() {
    ...
    jQuery.ajax({
      ...
      success: function(result){
            ...
            jQuery('#check_my_price_now_popup').modal('show');
...
function ncm_add_to_cart( post_id, booking_date, narnoo_bdate='', booking_code='', pickup='', dropoff='', passenger='' ) {
